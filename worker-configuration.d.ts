/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env dev` (hash: 214263a2ce84f0fdcb2f6bea44add464)
// Runtime types generated with workerd@1.20260426.1 2024-12-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index.dev");
	}
	interface Env {
		DB: D1Database;
		JWKS_URL: string;
